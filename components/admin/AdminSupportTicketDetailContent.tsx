...
function statusBadgeColor(status: string): string {
  switch (status) {
    case "open":
      return "bg-zinc-100 text-zinc-800 dark:bg-zinc-900/30 dark:text-zinc-300 border-zinc-300/30 shadow-[0_4px_12px_rgba(0,0,0,0.2)]";
    case "in_progress":
      return "bg-zinc-100 text-zinc-800 dark:bg-zinc-900/30 dark:text-zinc-300 border-zinc-300/30 shadow-[0_4px_12px_rgba(0,0,0,0.2)]";
    case "resolved":
      return "bg-zinc-100 text-zinc-800 dark:bg-zinc-900/30 dark:text-zinc-300 border-zinc-300/30 shadow-[0_4px_12px_rgba(0,0,0,0.2)]";
...
function priorityBadgeColor(priority: string): string {
  switch (priority) {
    case "urgent":
      return "bg-zinc-100 text-zinc-800 dark:bg-zinc-900/30 dark:text-zinc-300 border-zinc-300/30 shadow-[0_4px_12px_rgba(239,68,68,0.2)]";
    case "high":
      return "bg-zinc-100 text-zinc-800 dark:bg-zinc-900/30 dark:text-zinc-300 border-zinc-300/30 shadow-[0_4px_12px_rgba(0,0,0,0.2)]";
    case "medium":
      return "bg-zinc-100 text-zinc-800 dark:bg-zinc-900/30 dark:text-zinc-300 border-zinc-300/30 shadow-[0_4px_12px_rgba(0,0,0,0.2)]";
                  ...
                  <div>
                    ...
                    <dd className="flex flex-col gap-0.5">
                      <Link
                        ...
                        className="font-medium text-zinc-600 dark:text-zinc-400 hover:text-zinc-500 dark:hover:text-zinc-300 inline-flex items-center gap-1"
                      >
          ...
          <CardContent className="space-y-3">
            ...
            <form onSubmit={handleSubmitReply} className="space-y-3">
              ...
              <Button
                ...
                className="gap-2 rounded-xl border border-zinc-400/30 bg-gradient-to-r from-zinc-500/60 to-zinc-500/40 text-white shadow-[0_10px_30px_rgba(0,0,0,0.2)] hover:from-zinc-500/70 hover:to-zinc-500/50"
              >
