  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
      ...
      {onViewFilterChange &&
        (!viewSelectMounted ? (
          <div
            className="h-10 w-[180px] rounded-[28px] border border-zinc-400/30 dark:border-zinc-400/30 bg-white/10 dark:bg-white/5 text-gray-900 dark:text-white flex items-center justify-between px-3 py-2"
            aria-hidden
          >
          ...
          >
            <SelectTrigger
              className="h-10 w-[180px] rounded-[28px] border border-zinc-400/30 dark:border-zinc-400/30 bg-white/10 dark:bg-white/5 text-gray-900 dark:text-white"
            >
              <SelectValue placeholder="View" />
            </SelectTrigger>
            <SelectContent className="rounded-xl border-zinc-400/20">
