        ...
        <div className="max-w-9xl mx-auto space-y-6">
          ...
          {stockSummary && stockSummary.totalProducts > 0 && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <GlassCard variant="sky" className="text-center">
                ...
                >
                  <Boxes className="h-5 w-5 text-zinc-600 dark:text-zinc-400" />
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <GlassCard variant="cyan">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2 text-sm p-3 rounded-xl bg-gradient-to-r from-zinc-100/50 via-zinc-50/30 to-transparent dark:from-zinc-500/10 dark:via-zinc-500/5 dark:to-transparent border border-zinc-200/30 dark:border-zinc-400/10">
                  <Warehouse className="h-4 w-4 text-zinc-500 dark:text-zinc-400 mt-0.5 shrink-0" />
                  <div className="flex-1">
                ...
                {warehouse.location && (
                  <div className="flex items-start gap-2 text-sm p-3 rounded-xl bg-gradient-to-r from-zinc-100/50 via-zinc-50/30 to-transparent dark:from-zinc-500/10 dark:via-zinc-500/5 dark:to-transparent border border-zinc-200/30 dark:border-zinc-400/10">
                    <MapPin className="h-4 w-4 text-zinc-500 dark:text-zinc-400 mt-0.5 shrink-0" />
                    <div className="flex-1">
                      <span className="text-gray-600 dark:text-gray-400">
                        Location:
                      </span>
                ...
                {warehouse.description && (
                  <div className="flex items-center gap-2 text-sm p-3 rounded-xl bg-gradient-to-r from-zinc-100/50 via-zinc-50/30 to-transparent dark:from-zinc-500/10 dark:via-zinc-500/5 dark:to-transparent border border-zinc-200/30 dark:border-zinc-400/10">
                    <Tag className="h-4 w-4 text-zinc-500 dark:text-zinc-400 shrink-0" />
                    <span className="text-gray-600 dark:text-gray-400">
                      Description:
                    </span>
                ...
                {updatedAt && (
                  <div className="flex items-center gap-2 text-sm p-3 rounded-xl bg-gradient-to-r from-zinc-100/50 via-zinc-50/30 to-transparent dark:from-zinc-500/10 dark:via-zinc-500/5 dark:to-transparent border border-zinc-200/30 dark:border-zinc-400/10">
                    <Clock className="h-4 w-4 text-zinc-500 dark:text-zinc-400 shrink-0" />
                    <span className="text-gray-600 dark:text-gray-400">
                      Updated:
                    </span>
                    <span className="font-medium text-gray-900 dark:text-white">
            ...
            <GlassCard variant="violet">
              ...
              <div className="mt-4">
                {isLoadingStock ? (
                  ...
                  <div className="text-center py-8 rounded-xl bg-white/30 dark:bg-white/5 border border-zinc-200/30 dark:border-zinc-400/10">
                    <div
                      className={cn(
                    ...
                    >
                      <Package className="h-8 w-8 text-zinc-500/50 dark:text-zinc-400/50" />
                    </div>
